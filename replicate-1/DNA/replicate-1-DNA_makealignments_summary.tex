...
\centerline{\includegraphics[width=4in]{replicate-1-DNA_alignmentstatistics.pdf}}
\vspace{0.3in}

\centerline{\includegraphics[width=4in]{replicate-1-DNA_insertlengths.pdf}}
\end{minipage}
...
\centerline{\includegraphics[width=3in]{replicate-1-DNA_R1mismatches.pdf}\hspace{0.3in}\includegraphics[width=3in]{replicate-1-DNA_R2mismatches.pdf}}
\end{document}
