...
\centerline{\includegraphics[width=4in]{replicate-2-mutvir_MxA_alignmentstatistics.pdf}}
\vspace{0.3in}

\centerline{\includegraphics[width=4in]{replicate-2-mutvir_MxA_insertlengths.pdf}}
\end{minipage}
...
\centerline{\includegraphics[width=3in]{replicate-2-mutvir_MxA_R1mismatches.pdf}\hspace{0.3in}\includegraphics[width=3in]{replicate-2-mutvir_MxA_R2mismatches.pdf}}
\end{document}
